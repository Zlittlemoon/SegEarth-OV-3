...
img_path = 'data/LoveDA/img_dir/val/3514.png'  # <-- 和你 demo 中一样的路径
gt_path = 'data/LoveDA/ann_dir/val/3514.png'                  # <-- 你的 GT 路径
...
plt.tight_layout()
plt.savefig('visualize/LoveDA_3514.png', bbox_inches='tight', dpi=300)
plt.show()
