...
def parse_args():
    ...
    parser.add_argument("config", default="./configs/cfg_udd5_sr_input.py")
    parser.add_argument(
...
def main():
    ...
    if runner.rank == 0:
        append_experiment_result("results_sam3_sr_input_ttst.xlsx", [results])

    if runner.rank == 0:
        with open(os.path.join(cfg.work_dir, "results_sam3_sr_input_ttst.txt"), "a") as f:
