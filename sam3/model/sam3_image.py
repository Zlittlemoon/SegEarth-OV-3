...
class Sam3Image(torch.nn.Module):
    ...
    def _get_img_feats(self, backbone_out, img_ids):
        ...
        if "backbone_fpn" in backbone_out:
            ...
            # img_pos_embeds: shape [[5184, 1, 256]]
            # vis_feat_sizes: torch.Size([72, 72])
    ...
    def _encode_prompt(
        ...
        if prev_mask_pred is not None:
            img_feats = [img_feats[-1] + prev_mask_pred] # [5184, 1, 256]
        # Encode geometry
    ...
    def _run_segmentation_heads(
        ...
        if self.segmentation_head is not None:
            ...
            seg_head_outputs = activation_ckpt_wrapper(self.segmentation_head)(
                ...
                prompt=prompt,
                prompt_mask=prompt_mask,
            ) # ['pred_masks', 'semantic_seg', 'presence_logit']. 'pred_masks': [1, 200, 288, 288]; 'semantic_seg': [1, 1, 288, 288]; 'pred_masks': None
