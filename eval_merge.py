...
def main():
    ...
    if runner.rank == 0:
        append_experiment_result('results_OV3heads_softprompt_796k_concat_epoch20.xlsx', [results])

    if runner.rank == 0:
        with open(os.path.join(cfg.work_dir, 'results_OV3heads_softprompt_796k_concat_epoch20.txt'), 'a') as f:
