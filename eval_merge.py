...
def main():
    ...
    if runner.rank == 0:
        append_experiment_result('results_OV3heads_mmdec_pixeldec_only_decoder_1xA6000_11_8M_epoch20_lr_1e-3_weight_1.xlsx', [results])

    if runner.rank == 0:
        with open(os.path.join(cfg.work_dir, 'results_OV3heads_mmdec_pixeldec_only_decoder_1xA6000_11_8M_epoch20_lr_1e-3_weight_1.txt'), 'a') as f:
